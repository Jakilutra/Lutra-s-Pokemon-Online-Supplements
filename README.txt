...
If you host your server directory on a web server with PHP, you can just place tiers.php and tiersinfo.php in your server directory and link to tiers.php to provide easy-to-read tier information to your users.

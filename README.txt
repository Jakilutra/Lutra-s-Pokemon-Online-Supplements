...
N.B. Make sure your chosen scripts.js file, tiers.html and tiersinfo.php are not under any directories such as autoupdatescript/ or fullscript/ when adding them to your own PO server directory.
...
scripts.commands = {
	scriptscommands: function(src, channel, command){
		...
		+ "<tr><td><center>" + usymbol + "<b><font color='green'>/about</font></b>: displays script information. </center></td></tr>"
		commanddisplay(src, "Scripts Commands", display, channel);	
	}
	,
	about: function(src, channel, command){
		var numberofscripts = 1 + construction.units.length, scriptlines = sys.getFileContent("scripts.js").split(/\u000A/g).length, scriptcharacters = sys.getFileContent("scripts.js").length, index;
